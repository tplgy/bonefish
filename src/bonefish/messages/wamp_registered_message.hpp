...
inline const wamp_request_id wamp_registered_message::get_request_id() const
{
    return wamp_request_id(m_request_id.as<uint64_t>());
}

inline const wamp_registration_id wamp_registered_message::get_registration_id() const
{
